...
if(removeEntitlementProcesses){
    var path_Entitlment_Proccess = FOLDER_BACK_UP+"entitlementProcesses/tm ico process.entitlementProcess-meta.xml" ;
    if (fs.existsSync(path_Entitlment_Proccess)) {
       fs.unlinkSync(path_Entitlment_Proccess);
   }
   var path_Entitlment_Proccess = FOLDER_BACK_UP+"entitlementProcesses/tm ofcom process.entitlementProcess-meta.xml" ;
 if (fs.existsSync(path_Entitlment_Proccess)) {
    fs.unlinkSync(path_Entitlment_Proccess);
}
var path_Entitlment_Proccess = FOLDER_BACK_UP+"entitlementProcesses/tm standard process.entitlementProcess-meta.xml" ;
 if (fs.existsSync(path_Entitlment_Proccess)) {
    fs.unlinkSync(path_Entitlment_Proccess);
}
}
 ...
 var path_profile_pass_policy      = FOLDER_BACK_UP + "profilePasswordPolicies/PT1_profilePasswordPolicy1559051539083.profilePasswordPolicy-meta.xml";
 var path_profile_session_settings = FOLDER_BACK_UP + "profileSessionSettings/PT1_profileSessionSetting1559051539141.profileSessionSetting-meta.xml";
